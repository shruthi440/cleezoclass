...
type Props = NativeStackScreenProps<RootStackParamList, 'TeacherMessage'>;

const TeacherMessage: React.FC<Props> = ({ navigation, route }) => (
  <SafeAreaView style={styles.screen}>
    ...
    <View style={styles.header}>
      ...
      <TouchableOpacity
        ...
        onPress={() => navigation.navigate('TeacherDashboard', route.params)}
      >
